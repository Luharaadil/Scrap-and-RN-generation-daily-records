...
export function MainReport() {
  ...
  }, [date, loading, copiedText, copiedImage, sidebarOpen]);
              ...
              <TableBody>
                <TableRow>
                  ...
                  {days.map((d) => {
                    ...
                    return renderCell(d, 'BIC', summary ? (summary.bicUsage ?? 0) : null);
                  })}
                </TableRow>
                <TableRow>
                  <TableCell className="border border-gray-300 font-medium leading-tight py-2 min-w-[150px] max-w-[250px] whitespace-normal">
                ...
                <TableRow className="bg-[#e2f0d9]">
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'BIC', calculateRate(getCustomScrapForDate(d, 'BIC'), summary ? (summary.bicUsage ?? 0) : null));
                  })}
                </TableRow>
                ...
                <TableRow>
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'PLY_CHAFER', summary ? (summary.plyUsage ?? 0) : null);
                  })}
                </TableRow>
                <TableRow>
                  <TableCell className="border border-gray-300 font-medium leading-tight py-2 min-w-[150px] max-w-[250px] whitespace-normal">
                ...
                <TableRow className="bg-[#fce4d6]">
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'PLY_CHAFER', calculateRate(getCustomScrapForDate(d, 'PLY_CHAFER'), summary ? (summary.plyUsage ?? 0) : null));
                  })}
                </TableRow>
                ...
                <TableRow>
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'RUBBER_MIXING', summary ? (summary.mixingRubberUsage ?? summary.rubberUsage ?? 0) : null);
                  })}
                </TableRow>
                <TableRow>
                  <TableCell className="border border-gray-300 font-medium leading-tight py-2 min-w-[150px] max-w-[250px] whitespace-normal">
                ...
                <TableRow className="bg-[#ddebf7]">
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'RUBBER_MIXING', calculateRate(getCustomScrapForDate(d, 'RUBBER_MIXING'), summary ? (summary.mixingRubberUsage ?? summary.rubberUsage ?? 0) : null));
                  })}
                </TableRow>
                ...
                <TableRow>
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'RN', summary ? (summary.extrusionRubberUsage ?? 0) : null);
                  })}
                </TableRow>
                <TableRow>
                  <TableCell className="border border-gray-300 font-medium leading-tight py-2 min-w-[150px] max-w-[250px] whitespace-normal">
                ...
                <TableRow className="bg-[#ddebf7]">
                  ...
                  {days.map((d) => {
                    const summary = getSummaryForDate(d);
                    return renderCell(d, 'RN', calculateRate(getCustomScrapForDate(d, 'RN'), summary ? (summary.extrusionRubberUsage ?? 0) : null));
                  })}
                </TableRow>
              </TableBody>
            </Table>
