    ...
    setControls(
      <div className="flex items-center gap-1 sm:gap-2 flex-nowrap overflow-x-auto pb-1 no-scrollbar">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 flex-nowrap">
          <Button variant="outline" size="sm" onClick={copyValuesOnly} title="Copy values only (for Excel)" className="h-7 px-1.5 sm:h-8 sm:px-2 font-bold text-[9px] sm:text-xs flex-shrink-0">
