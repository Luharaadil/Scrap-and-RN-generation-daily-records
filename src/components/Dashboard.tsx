          ...
          <CardContent>
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between border-t pt-1 mt-1">
                ...
                <span className="font-bold">{calculateRate(displayBicScrap, summary.bicUsage)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between border-t pt-1 mt-1">
                <span className="text-muted-foreground">Scrap Rate:</span>
                <span className="font-bold">{calculateRate(displayPlyScrap, summary.plyUsage)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between border-t pt-1 mt-1">
                <span className="text-muted-foreground">Scrap Rate:</span>
                <span className="font-bold">{calculateRate(displayRubberScrap, summary.rubberUsage)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between border-t pt-1 mt-1">
                <span className="text-muted-foreground">Scrap Rate:</span>
                <span className="font-bold">{calculateRate(displayRnScrap, summary.extrusionRubberUsage)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
